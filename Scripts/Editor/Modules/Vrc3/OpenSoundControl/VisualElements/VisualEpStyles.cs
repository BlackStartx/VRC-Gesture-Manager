...
namespace GestureManager.Scripts.Editor.Modules.Vrc3.OpenSoundControl.VisualElements
{
    public static class VisualEpStyles
    {
        ...
        public static StyleValue<Color> BgColor = new Color(0.21f, 0.52f, 0.57f);

        internal static VisualElement Center => new VisualElement
        {
            pickingMode = PickingMode.Ignore,
            style = { height = InnerSize, width = InnerSize, positionLeft = TextHeight + TextMargin }
        };
        ...
        internal static TextElement HorizontalText => new TextElement
        {
            ...
            style =
            {
                ...
                positionRight = -TextHeight - TextMargin,
                positionTop = -TextHeight + TextMargin,
                backgroundColor = Color.black,
        ...
        internal static TextElement VerticalText
        {
            get
            {
                ...
                element.style.positionRight = -TextHeight;
                element.style.positionTop = -InnerSize;
