...
namespace GestureManager.Scripts.Editor.Modules.Vrc3
{
    public static class RadialMenuUtility
    {
        ...
        public static class Prefabs
        {
            ...
            internal static GmgCircleElement NewCircle(float size, Color color, Color border, PositionType position = default) => SetCircle(new GmgCircleElement(), size, color, color, border, position);

            internal static GmgCircleElement NewCircle(float size, Color centerColor, Color color, Color border, PositionType position = default) => SetCircle(new GmgCircleElement(), size, centerColor, color, border, position);

            internal static GmgCircleElement SetCircle(GmgCircleElement element, float size, Color color, Color border, PositionType position = default) => SetCircle(element, size, color, color, border, position);

            private static GmgCircleElement SetCircle(GmgCircleElement element, float size, Color centerColor, Color color, Color border, PositionType position = default)
            {
                ...
                element.style.positionType = position;
            ...
            internal static VisualElement NewRadialText(out TextElement text, int top, PositionType position = default)
            {
                return SetRadialText(new VisualElement(), out text, top, position);
            }

            internal static VisualElement SetRadialText(VisualElement element, out TextElement text, int top, PositionType position = default)
            {
                ...
                element.style.positionType = position;
                if (top != 0) element.style.positionTop = top;
