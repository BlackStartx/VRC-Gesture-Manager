...
namespace BlackStartX.GestureManager.Editor.Modules.Vrc3
{
    public static class ModuleVrc3Styles
    {
        ...
        internal static Texture2D Emojis => _emojis ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Emojis");
        internal static Texture2D Option => _option ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Option");
        internal static Texture2D Expressions => _expressions ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Expressions");
        internal static Texture2D Tools => _tools ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Tools");
        internal static Texture2D Back => _back ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Back");
        internal static Texture2D BackHome => _backHome ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_BackHome");
        internal static Texture2D Default => _default ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Default");
        internal static Texture2D Gear => _gear ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Gear");
        internal static Texture2D Reset => _reset ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Reset");
        internal static Texture2D TwoAxis => _twoAxis ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_2_Axis");
        internal static Texture2D FourAxis => _fourAxis ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_4_Axis");
        internal static Texture2D Radial => _radial ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Radial");
        internal static Texture2D Toggle => _toggle ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Toggle");
        internal static Texture2D ResetHeight => _resetHeight ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Reset_Height");
        internal static Texture2D AvatarHeight => _avatarHeight ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Avatar_Height");
        internal static Texture2D ReleasePoses => _releasePoses ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Release_Poses");
        internal static Texture2D RunningParam => _runningParam ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Running_Param");
        internal static Texture2D AxisUp => _axisUp ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Axis_Up");
        internal static Texture2D AxisRight => _axisRight ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Axis_Right");
        internal static Texture2D AxisDown => _axisDown ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Axis_Down");
        internal static Texture2D AxisLeft => _axisLeft ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Axis_Left");
        internal static Texture2D SupportLike => _supportLike ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Support_Like");
        internal static Texture2D SupportGold => _supportGold ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Support_Gold");
        internal static Texture2D SupportHeart => _supportHeart ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Support_Heart");
        internal static Texture2D ToolCamera => _toolCamera ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Tool_Camera");
        internal static Texture2D ToolClick => _toolClick ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Tool_Click");
        internal static Texture2D ToolPose => _toolPose ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Tool_Pose");
        internal static Texture2D Earmuffs => _earmuffs ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Earmuffs");
        internal static Texture2D FallingSpeed => _fallingSpeed ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_FallingSpeed");
        internal static Texture2D FullBody => _fullBody ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_FullBody");
        internal static Texture2D Generic => _generic ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Generic");
        internal static Texture2D GestureLeftWeight => _gestureLeftWeight ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_GestureLeftWeight");
        internal static Texture2D GestureRightWeight => _gestureRightWeight ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_GestureRightWeight");
        internal static Texture2D Grounded => _grounded ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Grounded");
        internal static Texture2D HandsOnly => _handsOnly ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_HandsOnly");
        internal static Texture2D HeadHands => _headHands ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_HeadHands");
        internal static Texture2D PoseIK => _poseIk ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Pose_IK");
        internal static Texture2D MuteSelf => _muteSelf ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_MuteSelf");
        internal static Texture2D Seated => _seated ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Seated");
        internal static Texture2D PoseT => _poseT ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Pose_T");
        internal static Texture2D Upright => _upright ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Upright");
        internal static Texture2D Velocity => _velocity ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Velocity");
        internal static Texture2D Visemes => _visemes ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Visemes");
        internal static Texture2D VRMode => _vRMode ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_VRMode");
        internal static Texture2D Afk => _afk ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_AFK");
        internal static Texture2D FourPoint => _fourPoint ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_FourPoint");
        internal static Texture2D Uninitialized => _uninitialized ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Uninitialized");
        internal static Texture2D IsLocal => _isLocal ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_IsLocal");
        internal static Texture2D Extras => _extras ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_Extras");
        internal static Texture2D IsOnFriendsList => _isOnFriendsList ??= Resources.Load<Texture2D>("Vrc3/BSX_GM_IsOnFriendsList");
        ...
        private static class Masks
        {
            ...
            internal static AvatarMask Empty => _empty ??= CreateEmptyMask();

            internal static AvatarMask Hands => _hands ??= CreateHandsMask();

            internal static AvatarMask Armature => _armature ??= CreateArmatureMask();
