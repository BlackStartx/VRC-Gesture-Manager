...
namespace GestureManager.Scripts.Editor.Modules.Vrc3
{
    public class RadialMenu : Vrc3VisualRender
    {
        ...
        private Vector2 ExternalPosition()
        {
            ...
            if (_puppet != null) vector2 -= new Vector2(_puppet.style.positionLeft.value, _puppet.style.positionTop.value);
            return vector2;
        }
        ...
        protected override bool RenderCondition(ModuleVrc3 module, RadialMenu menu) => menu.ToolBar.Selected != 2;
        ...
        private void CreateRadial()
        {
            ...
            _borderHolder = _radial.MyAdd(new VisualElement { pickingMode = PickingMode.Ignore, style = { positionType = PositionType.Absolute } });
            ...
            _dataHolder = _radial.MyAdd(new VisualElement { pickingMode = PickingMode.Ignore, style = { positionType = PositionType.Absolute } });
            _puppetHolder = _radial.MyAdd(new VisualElement { pickingMode = PickingMode.Ignore, style = { positionType = PositionType.Absolute } });
